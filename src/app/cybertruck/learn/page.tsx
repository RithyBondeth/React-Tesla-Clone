...
export default function CybertruckLearnPage({
  ...
  return (
    <div className="bg-cybertruckBlackBg">
      {/* Navbar Section */}
      <div
        onMouseOver={() => setIsHoverOnNav(true)}
        onMouseOut={() => setIsHoverOnNav(false)}
      >
        <Navbar isWhiteText />
      </div>
      {/* End Navbar Section */}
      ...
      {/* Poster Section */}
      <div
        className={`h-screen w-full bg-center bg-cover bg-no-repeat relative ${isHoverOnNav && "-z-10"}`}
      ...
      <div className="mx-16 mt-20 flex flex-col items-center">
        <div className="relative">
          ...
          <div className="relative flex items-start py-5 pb-10 mx-5">
            ...
            <div className="w-2/3 px-16 leading-8 text-cybertruckGrayText">
        ...
        <Link
          to={cybertruck.learnMoreData.buildForAnyPlanet.guideLink}
          target="_blank"
      ...
      <div className="relative mx-32 mt-20 flex justify-between items-center">
        ...
        <div className="w-1/2 ml-5 my-5">
          ...
          <div className="relative w-full text-cybertruckGrayText flex flex-col justify-end items-end">
            ...
            <p className="text-sm text-right leading-10 py-5 pl-20">
      ...
      {cybertruck.learnMoreData.advertisements.map((e, index) => (
        <div
          className={`relative mx-40 mt-20 p-5 ${index === cybertruck.learnMoreData.advertisements.length - 1 && "mb-20"} h-screen flex justify-center items-center`}
          key={index}
        >
          <div className="absolute top-0 left-0 h-20 w-20 border-t-[1px] border-l-[1px] border-cybertruckGrayBorder" />
          ...
          <div
            className="w-[60%] h-full bg-center bg-cover bg-no-repeat"
      ...
      >
        <div
          className="absolute top-10 left-20 w-1/4 p-5 border-t-4 border-white bg-black opacity-80"
          style={{
            clipPath:
      ...
      <div className="relative mx-16 mt-20 p-5 h-screen flex justify-center items-center">
        ...
        <div
          className="h-full w-[65%] ml-3 bg-center bg-cover bg-no-repeat"
          style={{
          ...
          {cybertruck.learnMoreData.slideshows.map((e, index) => (
            ...
            >
              <div
                ...
                style={{
                  backgroundImage: `url(${index % 2 === 0 && e.image})`,
                }}
              >
                {index % 2 !== 0 && (
